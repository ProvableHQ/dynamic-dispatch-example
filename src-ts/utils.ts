 ...
 * name as a little-endian integer. This is the value that interface-based
 * dynamic dispatch uses to identify the target program at runtime.
 *
 * Example: identifierToField("toka_token") => "1634430836field"
 */
